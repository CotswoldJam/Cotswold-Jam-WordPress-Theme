 ...
 * @var string
 */
define( 'PRIMER_CHILD_VERSION', '0.1' );
 ...
 * @since  1.0.0
 */
function cotswoldjam_move_elements() {
...
add_action( 'template_redirect', 'cotswoldjam_move_elements' );
 ...
 * @return string
 */
function cotswoldjam_hero_image_selector() {

	return '.hero';

}
add_filter( 'primer_hero_image_selector', 'cotswoldjam_hero_image_selector' );
 ...
 * @return array
 */
function cotswoldjam_custom_logo_args( $args ) {
...
add_filter( 'primer_custom_logo_args', 'cotswoldjam_custom_logo_args' );
 ...
 * @return array
 */
function cotswoldjam_sidebars( $sidebars ) {

	$sidebars['footer-4'] = array(
		'name'          => esc_html__( 'Footer 4', 'cotswoldjam' ),
		'description'   => esc_html__( 'This sidebar is the fourth column of the footer widget area.', 'cotswoldjam' ),
...
add_filter( 'primer_sidebars', 'cotswoldjam_sidebars' );
 ...
 * @return array
 */
function cotswoldjam_fonts( $fonts ) {
...
add_filter( 'primer_fonts', 'cotswoldjam_fonts' );
 ...
 * @return array
 */
function cotswoldjam_font_types( $font_types ) {
...
add_filter( 'primer_font_types', 'cotswoldjam_font_types' );
 ...
 * @return array
 */
function cotswoldjam_colors( $colors ) {
...
add_filter( 'primer_colors', 'cotswoldjam_colors' );
 ...
 * @return array
 */
function cotswoldjam_color_schemes( $color_schemes ) {
...
add_filter( 'primer_color_schemes', 'cotswoldjam_color_schemes' );
